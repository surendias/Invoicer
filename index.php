...
<head>
    ...
    <title>Invoicer | Free invoicing for freelancers.</title>
...
<form action="process_invoice_mpdf.php" method="post" id="invoice_form">
...
<div class="row footer">
    <div class="large-12 columns text-center">
        <p class="copyright"><a href="https://github.com/surendias/Invoicer" target="_blank">Source on github</a></p>
    </div>
</div>
