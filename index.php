...
<form action="process_invoice.php" method="post" id="invoice_form">
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            <a class="button" onclick="javascript:addLineItem();">Add Line Item</a>
            ...
            <table id="invoice-details-table">
                ...
                <tr>
                    ...
                    <td><input type="button" class="button small alert" value="X" onclick="removeLineItem(this)"/></td>
                </tr>
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            <div class="row text-center">
                <div class="large-12 columns">
                    <input type="submit" class="button success" value="Generate PDF"/>
                </div>
            </div>
        </div>
    </div>
...
<script>
    function addLineItem() {
        ...
        cell7.innerHTML = '<input type="button" class="button small alert" value="X" onclick="removeLineItem(this)"/>';
